...
namespace Solutions.TodoList.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class RemoveMaterializedTodos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"DROP TRIGGER IF EXISTS tr_sync_materialized_todos ON public.""Todos"";");
            migrationBuilder.Sql(@"DROP FUNCTION IF EXISTS public.sync_materialized_todos();");
            migrationBuilder.Sql(@"DROP TABLE IF EXISTS public.materialized_todos;");
        }
